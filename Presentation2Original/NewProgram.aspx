<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewProgram.aspx.cs" Inherits="Capstone2nd.NewProgram" %>
...
<head runat="server">
  ...
  <title>Add New Program Page</title>
...
<body id="page-top">
    ...
    <form id="form1" runat="server">
        ...
        <asp:CheckBoxList ID="subject" runat="server" Font-Size="10" Font-Strikeout="False" ForeColor="Black" TextAlign="Left" AutoPostBack="true" OnSelectedIndexChanged="subject_SelectedIndexChanged">
        </asp:CheckBoxList>
        ...
        <asp:DropDownList ID="Progdescription" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Progdescription_SelectedIndexChanged">
        </asp:DropDownList><br />
        ...
        <asp:RadioButtonList ID="radioCost" runat="server" Font-Size="10" Font-Strikeout="False" ForeColor="Black" TextAlign="Left" AutoPostBack="true" OnSelectedIndexChanged="radioCost_SelectedIndexChanged">   
        ...
        <asp:RadioButtonList ID="UniAff" runat="server" AutoPostBack="true" OnSelectedIndexChanged="UniAff_SelectedIndexChanged">
        ...
        <asp:Label ID="lbOutReach" runat="server" Text="Is this outreach program affiliated with a company, institute or other organization not considered a college or university?" ForeColor="Black" Font-Size="14pt"></asp:Label><br />
         <asp:RadioButtonList ID="OutReach" runat="server" AutoPostBack="true" OnSelectedIndexChanged="OutReach_SelectedIndexChanged">
            <asp:ListItem value="Yes"></asp:ListItem>
            <asp:ListItem value="No"></asp:ListItem>
        </asp:RadioButtonList><br /><br /><br />
        ...
        <asp:DropDownList ID="ServiceArea" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ServiceArea_SelectedIndexChanged">
