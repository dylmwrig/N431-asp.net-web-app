...
<body>
    ...
    <div>
        <asp:Panel Height="112px" ID="Panel1" runat="server" Width="255px" BorderWidth="2px">
            ...
            <asp:Button ID="Button1" runat="server" Text="Validate Group1" ValidationGroup="Group1"/>
            
        </asp:Panel>   
        
             
        &nbsp;<br />
        <asp:Panel Height="94px" ID="Panel2" runat="server" Width="255px" BorderWidth="2px">
            ...
            <asp:Button ID="Button2" runat="server" Text="Validate Group2" ValidationGroup="Group2"/>
