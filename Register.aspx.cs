        ...
        protected void Confirm_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (radioUserTypeForm == "Program Manager")
                {
                    ...
                    "values(@roleID, @prefix, @firstName, @middleName, @lastName, @sufix, @email, @pass, @altEmail, @altPass, @phone, @address," +
                    ...
                    cmd.Parameters.Add(new SqlParameter("@altPass", Session["altPassRegForm"]));
                ...
                { //if radioUserTypeForm = Guest
                    string sql = "INSERT INTO  Guest  (prefix, firstName, middleName, lastName, sufix, email, password, altEmail, altPassword, phone," +
                    "address, registerDate, lastLogin, approved, currLoggedIn, rndCode)" +
                    "values(@prefix, @firstName, @middleName, @lastName, @sufix, @email, @pass, @altEmail, @altPass, @phone, @address," +
                    "@registerDate, NULL, 'no', 'no', @rndCode);";
                    SqlCommand cmd = new SqlCommand(sql, con);
                    cmd.Parameters.Add(new SqlParameter("@prefix", prefixForm));
                    cmd.Parameters.Add(new SqlParameter("@firstName", firstNameForm));
